        ...
        <div class="col-12 col-lg-8 m-auto">
          <form class="multisteps-form__form" method="POST">
              ...
              <div class="multisteps-form__content">
                <div class="row mt-3">
                  <div class="col-12 col-sm-6">
                    ...
                    <input class="multisteps-form__input form-control" type="text" placeholder="Họ và tên"
                      maxlength="50" value="<?= isset($_POST['display_name']) ? $_POST['display_name'] : '' ?>"
                      name="display_name" />
                  </div>
                ...
                <div class="row mt-3">
                  <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                    ...
                    <input class="multisteps-form__input form-control" type="email"
                      placeholder="Email dùng để đăng nhập" name="email" maxlength="255"
                      value="<?= isset($_POST['email']) ? $_POST['email'] : '' ?>" />
                  </div>
                  <div class="col-12 col-sm-6">
                    <label>Số điện thoại</label>
                    <input class="multisteps-form__input form-control" type="tel" placeholder="Số điện thoại liên hệ"
                      maxlength="25" name="phone" value="<?= isset($_POST['phone']) ? $_POST['phone'] : '' ?>" />
                  </div>
                </div>
                <div class="button-row d-flex mt-4">
                  <button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next" type="button" title="Next">Tiếp
                    theo</button>
                </div>
              </div>
            </div>
            ...
            <div class="card multisteps-form__panel p-3 border-radius-xl bg-white" data-animation="FadeIn">
              ...
              <p class="mb-0 text-sm">Mật khẩu phải dài ít nhất 8 ký tự, nên sử dụng chữ hoa và chữ thường, số và các ký
                hiệu đặc biệt</p>
              <div class="multisteps-form__content mt-3">
                <div class="row mt-3">
                  <div class="col-12 col-sm-6">
                    ...
                    <input class="multisteps-form__input form-control" type="password" placeholder="******"
                      name="password" minlength="8" maxlength="255" />
                  </div>
                  <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                    <label>Nhập lại mật khẩu</label>
                    <input class="multisteps-form__input form-control" type="password" placeholder="******"
                      name="re_password" minlength="8" maxlength="255" />
                  </div>
                </div>
                ...
                <div class="button-row d-flex mt-4">
                  ...
                  <button class="btn bg-gradient-dark ms-auto mb-0" type="submit" title="Send">Tạo tài khoản</button>
                </div>
              </div>
            </div>
          </form>
